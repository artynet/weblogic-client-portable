...
# Set up BEA Home
#BEA_HOME="/sw/oracle/fusion_middleware_11"

# Set up Middleware Home
#MW_HOME="/sw/oracle/fusion_middleware_11"

# Set up WebLogic Home
#WL_HOME="/sw/oracle/fusion_middleware_11/wlserver_10.3"

# Set up COHERENCE Home
COHERENCE_HOME=""

# Set up Common Modules Directory
#MODULES_DIR="/sw/oracle/fusion_middleware_11/modules"

# Set up Common Features Directory
#FEATURES_DIR="/sw/oracle/fusion_middleware_11/modules/features"
